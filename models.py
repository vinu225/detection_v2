"""
models.py — Pydantic v2 schemas used across the entire pipeline.
These are pure data-transfer / validation objects; ORM models live in database.py.
"""
...
class CleanArticle(BaseModel):
    ...
    Matches the articles table schema in the database.
    """
    article_id: str
    title: str
    author: Optional[str] = None
